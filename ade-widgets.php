  ...
  * ---------------------------------------------------------- */
  ...
  function ade_widgets_menu() {
   ...
   add_submenu_page(
    ...
    'Slider Box Settings', // page title for tags '$page_title'
    'Slider Box', // menu title '$menu_title'
   ...
   add_submenu_page( //Blog Boxes
    'ade_widgets_menu', //top-menu slug
    'Blog Boxes Settings', // page title for tags '$page_title'
    'Blog Boxes', // menu title '$menu_title'
    'administrator', // permissions level
    'ade_widgets_blog_boxes_menu', // slug for menu
    'ade_widgets_blog_boxes_menu_output' // function to call
   );
 ...
 /*** HEADLINES PAGE ***/
  ...
  // HEADLINES WIDGET
    ...
    //Page = Headlines, Section = headlines_widget, Field = Number Posts
     ...
     //Page = Headlines, Section = headlines_widget, Field = Title
      add_settings_field(
       'ade_widgets_headlines_1_4', //ID with ade_ prefix
       'Title the Box', // field title
       'ade_widgets_headlines_1_4_callback', //field callback function
       'ade_widgets_headlines_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
       'ade_widgets_headlines_widget' // get this from add_settings_section $section_slug,
      );
  ...
  /*** BLOG BOXES PAGE ***/
     //register the below settings
     register_setting(
      'ade_widgets_blog_boxes_settings',
      'ade_widgets_blog_boxes_settings'
     ); // JUST KEEP THESE THE SAME

     // BOX 1
      // Page = Blog , Section = blog_corner_box_1
       add_settings_section(
        'ade_widgets_blog_boxes_box_1', //$id -- slug used in settings fields - $section_slug
        'Blog Box 1', // readable title on screen
        'ade_widgets_blog_boxes_box_1_callback', // function that echos content under Title
        'ade_widgets_blog_boxes_menu' // $menu_page_slug / slug name of the settings page to show section
       );

      //Page = Blog , Section = blog_corner_box_1
       add_settings_field(
        'ade_widgets_blog_boxes_box_1_1', //ID with ade_home_ prefix
        'Select Blog', // field title
        'ade_widgets_blog_boxes_box_1_1_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_1' // get this from add_settings_section $section_slug,
       );

      //Page = Blog , Section = blog_corner_box_1`
       add_settings_field(
        'ade_widgets_blog_boxes_box_1_2', //ID with ade_home_ prefix
        'Post ID', // field title
        'ade_widgets_blog_boxes_box_1_2_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_1' // get this from add_settings_section $section_slug,
       );
      ...
      //Page = Blog , Section = blog_corner_box_1
       add_settings_field(
        'ade_widgets_blog_boxes_box_1_3', //ID with ade_home_ prefix
        'Last Updated', // field title
        'ade_widgets_blog_boxes_box_1_3_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_1' // get this from add_settings_section $section_slug,
       );
      ...
      //Page = Blog , Section = blog_corner_box_1
       add_settings_field(
        'ade_widgets_blog_boxes_box_1_4', //ID with ade_home_ prefix
        'Banner Icon', // field title
        'ade_widgets_blog_boxes_box_1_4_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_1' // get this from add_settings_section $section_slug,
       );
      ...
      //Page = Blog , Section = blog_corner_box_1
       add_settings_field(
        'ade_widgets_blog_boxes_box_1_5', //ID with ade_home_ prefix
        'Banner Text', // field title
        'ade_widgets_blog_boxes_box_1_5_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_1' // get this from add_settings_section $section_slug,
       );

    // BOX 2
      // Page = Blog , Section = blog_corner_box_2
       add_settings_section(
        'ade_widgets_blog_boxes_box_2', //$id -- slug used in settings fields - $section_slug
        'Blog Box 2', // readable title on screen
        'ade_widgets_blog_boxes_box_2_callback', // function that echos content under Title
        'ade_widgets_blog_boxes_menu' // $menu_page_slug / slug name of the settings page to show section
       );

      //Page = Blog , Section = blog_corner_box_2
       add_settings_field(
        'ade_widgets_blog_boxes_box_2_1', //ID with ade_home_ prefix
        'Select Blog', // field title
        'ade_widgets_blog_boxes_box_2_1_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_2' // get this from add_settings_section $section_slug,
       );

      //Page = Blog , Section = blog_corner_box_2
       add_settings_field(
        'ade_widgets_blog_boxes_box_2_2', //ID with ade_home_ prefix
        'Post ID', // field title
        'ade_widgets_blog_boxes_box_2_2_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_2' // get this from add_settings_section $section_slug,
       );
      ...
      //Page = Blog , Section = blog_corner_box_2
       add_settings_field(
        'ade_widgets_blog_boxes_box_2_3', //ID with ade_home_ prefix
        'Last Updated', // field title
        'ade_widgets_blog_boxes_box_2_3_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_2' // get this from add_settings_section $section_slug,
       );
      ...
      //Page = Blog , Section = blog_corner_box_2
       add_settings_field(
        'ade_widgets_blog_boxes_box_2_4', //ID with ade_home_ prefix
        'Banner Icon', // field title
        'ade_widgets_blog_boxes_box_2_4_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_2' // get this from add_settings_section $section_slug,
       );
      ...
      //Page = Blog , Section = blog_corner_box_2
       add_settings_field(
        'ade_widgets_blog_boxes_box_2_5', //ID with ade_home_ prefix
        'Banner Text', // field title
        'ade_widgets_blog_boxes_box_2_5_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_2' // get this from add_settings_section $section_slug,
       );

     // BOX 3
      // Page = Blog , Section = blog_corner_box_3
       add_settings_section(
        'ade_widgets_blog_boxes_box_3', //$id -- slug used in settings fields - $section_slug
        'Blog Box 3', // readable title on screen
        'ade_widgets_blog_boxes_box_3_callback', // function that echos content under Title
        'ade_widgets_blog_boxes_menu' // $menu_page_slug / slug name of the settings page to show section
       );

      //Page = Blog , Section = blog_corner_box_3
       add_settings_field(
        'ade_widgets_blog_boxes_box_3_1', //ID with ade_home_ prefix
        'Select Blog', // field title
        'ade_widgets_blog_boxes_box_3_1_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_3' // get this from add_settings_section $section_slug,
       );

      //Page = Blog , Section = blog_corner_box_3
       add_settings_field(
        'ade_widgets_blog_boxes_box_3_2', //ID with ade_home_ prefix
        'Post ID', // field title
        'ade_widgets_blog_boxes_box_3_2_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_3' // get this from add_settings_section $section_slug,
       );
      ...
      //Page = Blog , Section = blog_corner_box_3
       add_settings_field(
        'ade_widgets_blog_boxes_box_3_3', //ID with ade_home_ prefix
        'Last Updated', // field title
        'ade_widgets_blog_boxes_box_3_3_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_3' // get this from add_settings_section $section_slug,
       );
      ...
      //Page = Blog , Section = blog_corner_box_3
       add_settings_field(
        'ade_widgets_blog_boxes_box_3_4', //ID with ade_home_ prefix
        'Banner Icon', // field title
        'ade_widgets_blog_boxes_box_3_4_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_3' // get this from add_settings_section $section_slug,
       );
      ...
      //Page = Blog , Section = blog_corner_box_3
       add_settings_field(
        'ade_widgets_blog_boxes_box_3_5', //ID with ade_home_ prefix
        'Banner Text', // field title
        'ade_widgets_blog_boxes_box_3_5_callback', //field callback function
        'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
        'ade_widgets_blog_boxes_box_3' // get this from add_settings_section $section_slug,
       );

     // BOX 4
       // Page = Blog , Section = blog_corner_box_4
        add_settings_section(
         'ade_widgets_blog_boxes_box_4', //$id -- slug used in settings fields - $section_slug
         'Blog Box 4', // readable title on screen
         'ade_widgets_blog_boxes_box_4_callback', // function that echos content under Title
         'ade_widgets_blog_boxes_menu' // $menu_page_slug / slug name of the settings page to show section
        );

       //Page = Blog , Section = blog_corner_box_4
        add_settings_field(
         'ade_widgets_blog_boxes_box_4_1', //ID with ade_home_ prefix
         'Select Blog', // field title
         'ade_widgets_blog_boxes_box_4_1_callback', //field callback function
         'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
         'ade_widgets_blog_boxes_box_4' // get this from add_settings_section $section_slug,
        );

       //Page = Blog , Section = blog_corner_box_4
        add_settings_field(
         'ade_widgets_blog_boxes_box_4_2', //ID with ade_home_ prefix
         'Post ID', // field title
         'ade_widgets_blog_boxes_box_4_2_callback', //field callback function
         'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
         'ade_widgets_blog_boxes_box_4' // get this from add_settings_section $section_slug,
        );
       ...
       //Page = Blog , Section = blog_corner_box_4
        add_settings_field(
         'ade_widgets_blog_boxes_box_4_3', //ID with ade_home_ prefix
         'Last Updated', // field title
         'ade_widgets_blog_boxes_box_4_3_callback', //field callback function
         'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
         'ade_widgets_blog_boxes_box_4' // get this from add_settings_section $section_slug,
        );
       ...
       //Page = Blog , Section = blog_corner_box_4
        add_settings_field(
         'ade_widgets_blog_boxes_box_4_4', //ID with ade_home_ prefix
         'Banner Icon', // field title
         'ade_widgets_blog_boxes_box_4_4_callback', //field callback function
         'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
         'ade_widgets_blog_boxes_box_4' // get this from add_settings_section $section_slug,
        );
       ...
       //Page = Blog , Section = blog_corner_box_4
        add_settings_field(
         'ade_widgets_blog_boxes_box_4_5', //ID with ade_home_ prefix
         'Banner Text', // field title
         'ade_widgets_blog_boxes_box_4_5_callback', //field callback function
         'ade_widgets_blog_boxes_menu', // $menu_page_slug - should be $menu_slug from do_settings_sections()
         'ade_widgets_blog_boxes_box_4' // get this from add_settings_section $section_slug,
        );
...
$all_sites = get_sites( $sitesarg );
  ...
  function ade_widgets_headlines_1_3_callback() {
   ...
   function ade_widgets_headlines_1_4_callback() {
     $setting = (array) get_option( 'ade_widgets_headlines_settings');

     $field = 'ade_widgets_headlines_1_4'; //get current post setting
     $current_num = esc_attr( $setting[$field] ); //get current post setting value

     $html = "<input type='text' name='ade_widgets_headlines_settings[$field]' value='$current_title' class='choose-new'/>";
     $html .= "<span class='current-choice'>Current Title: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'>".$current_title."</span>";
     echo $html;
   } //end ade_widgets_headlines_1_4_callback
...
/* ---------------------------------------------------------- *
 * CALLBACKS - BLOG BOXES
 * ---------------------------------------------------------- */

//  BLOG BOX 1

  function ade_widgets_blog_boxes_box_1_callback() {
    }

    function ade_widgets_blog_boxes_box_1_1_callback() {
      $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
      $field = 'ade_widgets_blog_boxes_box_1_1';
      $value = esc_attr( $setting[$field] );

      $html = "<select id='ade_widgets_blog_boxes_box_1_1_blog_select' name='ade_widgets_blog_boxes_settings[$field]' class='ade-widgets-choose-new'>";
      $html .= "<option id='no_blog' name='no_blog' value='no_blog'>Select Blog</option>";
...
$all_sites = get_sites( $sitesarg );
    ...
    function ade_widgets_blog_boxes_box_1_2_callback() {
        $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');

        $blog = 'ade_widgets_blog_boxes_box_1_1'; //get current blog setting
        $blog = esc_attr( $setting[$blog] );  //get current blog setting value
        ...
        $current_post_field = 'ade_widgets_blog_boxes_box_1_2'; //get current post setting
        $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
        ...
        $html = "<input type='text' name='ade_widgets_blog_boxes_settings[$current_post_field]' value='$current_post'  class='ade-widgets-choose-new' />";
        $html .= "<span class='current-choice'>Current Post: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'>".$current_post_title."</span>  (ID = ".$current_post.")";
        echo $html;
      }

      function ade_widgets_blog_boxes_box_1_3_callback() {
          $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
          $current_post_field = 'ade_widgets_blog_boxes_box_1_3'; //get current post setting
          $then = esc_attr( $setting[$current_post_field] ); //get current post setting value
          $lastdate = date( 'F d, Y', strtotime($then) );
          $now = date( 'F d, Y' );
          $html = "<input type='hidden' name='ade_widgets_blog_boxes_settings[$current_post_field]'  value='$then' class='ade-widgets-datefield' />";
          $html .= "<span class='current-choice'>This post was added to the homepage on $lastdate (Today is $now)</span>";
          echo $html;
        }

     function ade_widgets_blog_boxes_box_1_4_callback() {
         $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
         $current_post_field = 'ade_widgets_blog_boxes_box_1_4'; //get current post setting
         $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
         $html = "<input type='text' name='ade_widgets_blog_boxes_settings[$current_post_field]' class='ade-widgets-choose-new' value='$current_post' />";
         $html .= "<span class='current-choice'>Current: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'><i class='fa fa-".$current_post." fa-2x'></i></span>";
         echo $html;
       }

     function ade_widgets_blog_boxes_box_1_5_callback() {
         $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
         $current_post_field = 'ade_widgets_blog_boxes_box_1_5'; //get current post setting
         $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
         $html = "<input type='text' name='ade_widgets_blog_boxes_settings[$current_post_field]' class='ade-widgets-choose-new' value='$current_post' />";
         $html .= "<span class='current-choice'>Current: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'>".$current_post."</span>";
         echo $html;
   ...
   //  BLOG BOX 2
     ...
     function ade_widgets_blog_boxes_box_2_callback() {
       }

       function ade_widgets_blog_boxes_box_2_1_callback() {
         $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
         $field = 'ade_widgets_blog_boxes_box_2_1';
         $value = esc_attr( $setting[$field] );

         $html = "<select id='ade_widgets_blog_boxes_box_2_1_blog_select' name='ade_widgets_blog_boxes_settings[$field]' class='ade-widgets-choose-new'>";
         $html .= "<option id='no_blog' name='no_blog' value='no_blog'>Select Blog</option>";
       ...
       function ade_widgets_blog_boxes_box_2_2_callback() {
           $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');

           $blog = 'ade_widgets_blog_boxes_box_2_1'; //get current blog setting
           $blog = esc_attr( $setting[$blog] );  //get current blog setting value
           ...
           $current_post_field = 'ade_widgets_blog_boxes_box_2_2'; //get current post setting
           $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
         ...
         function ade_widgets_blog_boxes_box_2_3_callback() {
             $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
             $current_post_field = 'ade_widgets_blog_boxes_box_2_3'; //get current post setting
             $then = esc_attr( $setting[$current_post_field] ); //get current post setting value
             $lastdate = date( 'F d, Y', strtotime($then) );
             $now = date( 'F d, Y' );
             $html = "<input type='hidden' name='ade_widgets_blog_boxes_settings[$current_post_field]'  value='$then' class='ade-widgets-datefield' />";
        ...
        function ade_widgets_blog_boxes_box_2_4_callback() {
            $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
            $current_post_field = 'ade_widgets_blog_boxes_box_2_4'; //get current post setting
            $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
            $html = "<input type='text' name='ade_widgets_blog_boxes_settings[$current_post_field]' class='ade-widgets-choose-new' value='$current_post' />";
            $html .= "<span class='current-choice'>Current: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'><i class='fa fa-".$current_post." fa-2x'></i></span>";
            echo $html;
        ...
        function ade_widgets_blog_boxes_box_2_5_callback() {
            $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
            $current_post_field = 'ade_widgets_blog_boxes_box_2_5'; //get current post setting
            $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
            $html = "<input type='text' name='ade_widgets_blog_boxes_settings[$current_post_field]' class='ade-widgets-choose-new' value='$current_post' />";
            $html .= "<span class='current-choice'>Current: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'>".$current_post."</span>";
            echo $html;
    ...
    //  BLOG BOX 3
      ...
      function ade_widgets_blog_boxes_box_3_callback() {
        }

        function ade_widgets_blog_boxes_box_3_1_callback() {
          $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
          $field = 'ade_widgets_blog_boxes_box_3_1';
          $value = esc_attr( $setting[$field] );

          $html = "<select id='ade_widgets_blog_boxes_box_3_1_blog_select' name='ade_widgets_blog_boxes_settings[$field]' class='ade-widgets-choose-new'>";
          $html .= "<option id='no_blog' name='no_blog' value='no_blog'>Select Blog</option>";
...
$all_sites = get_sites( $sitesarg );
        ...
        function ade_widgets_blog_boxes_box_3_2_callback() {
            $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');

            $blog = 'ade_widgets_blog_boxes_box_3_1'; //get current blog setting
            $blog = esc_attr( $setting[$blog] );  //get current blog setting value
            ...
            $current_post_field = 'ade_widgets_blog_boxes_box_3_2'; //get current post setting
            $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
          ...
          function ade_widgets_blog_boxes_box_3_3_callback() {
              $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
              $current_post_field = 'ade_widgets_blog_boxes_box_3_3'; //get current post setting
              $then = esc_attr( $setting[$current_post_field] ); //get current post setting value
              $lastdate = date( 'F d, Y', strtotime($then) );
              $now = date( 'F d, Y' );
              $html = "<input type='hidden' name='ade_widgets_blog_boxes_settings[$current_post_field]'  value='$then' class='ade-widgets-datefield' />";
         ...
         function ade_widgets_blog_boxes_box_3_4_callback() {
             $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
             $current_post_field = 'ade_widgets_blog_boxes_box_3_4'; //get current post setting
             $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
             $html = "<input type='text' name='ade_widgets_blog_boxes_settings[$current_post_field]' class='ade-widgets-choose-new' value='$current_post' />";
             $html .= "<span class='current-choice'>Current: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'><i class='fa fa-".$current_post." fa-2x'></i></span>";
             echo $html;
         ...
         function ade_widgets_blog_boxes_box_3_5_callback() {
             $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
             $current_post_field = 'ade_widgets_blog_boxes_box_3_5'; //get current post setting
             $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
             $html = "<input type='text' name='ade_widgets_blog_boxes_settings[$current_post_field]' class='ade-widgets-choose-new' value='$current_post' />";
             $html .= "<span class='current-choice'>Current: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'>".$current_post."</span>";
             echo $html;
       ...
       //  BLOG BOX 4
         ...
         function ade_widgets_blog_boxes_box_4_callback() {
           }

           function ade_widgets_blog_boxes_box_4_1_callback() {
             $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
             $field = 'ade_widgets_blog_boxes_box_4_1';
             $value = esc_attr( $setting[$field] );

             $html = "<select id='ade_widgets_blog_boxes_box_4_1_blog_select' name='ade_widgets_blog_boxes_settings[$field]' class='ade-widgets-choose-new'>";
             $html .= "<option id='no_blog' name='no_blog' value='no_blog'>Select Blog</option>";
           ...
           function ade_widgets_blog_boxes_box_4_2_callback() {
               $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');

               $blog = 'ade_widgets_blog_boxes_box_4_1'; //get current blog setting
               $blog = esc_attr( $setting[$blog] );  //get current blog setting value
               ...
               $current_post_field = 'ade_widgets_blog_boxes_box_4_2'; //get current post setting
               $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
             ...
             function ade_widgets_blog_boxes_box_4_3_callback() {
                 $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
                 $current_post_field = 'ade_widgets_blog_boxes_box_4_3'; //get current post setting
                 $then = esc_attr( $setting[$current_post_field] ); //get current post setting value
                 $lastdate = date( 'F d, Y', strtotime($then) );
                 $now = date( 'F d, Y' );
                 $html = "<input type='hidden' name='ade_widgets_blog_boxes_settings[$current_post_field]'  value='$then' class='ade-widgets-datefield' />";
            ...
            function ade_widgets_blog_boxes_box_4_4_callback() {
                $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
                $current_post_field = 'ade_widgets_blog_boxes_box_4_4'; //get current post setting
                $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
                $html = "<input type='text' name='ade_widgets_blog_boxes_settings[$current_post_field]' class='ade-widgets-choose-new' value='$current_post' />";
                $html .= "<span class='current-choice'>Current: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'><i class='fa fa-".$current_post." fa-2x'></i></span>";
                echo $html;
            ...
            function ade_widgets_blog_boxes_box_4_5_callback() {
                $setting = (array) get_option( 'ade_widgets_blog_boxes_settings');
                $current_post_field = 'ade_widgets_blog_boxes_box_4_5'; //get current post setting
                $current_post = esc_attr( $setting[$current_post_field] ); //get current post setting value
                $html = "<input type='text' name='ade_widgets_blog_boxes_settings[$current_post_field]' class='ade-widgets-choose-new' value='$current_post' />";
                $html .= "<span class='current-choice'>Current: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class='boldtitle'>".$current_post."</span>";
                echo $html;
 ...
 <p><strong>NOTE: <em>Not for use in WordPress widget areas (sidebars).</em> Place this shortcode in your page or post content area only.</strong></p>
 ...
 <p>The box is configured to appear <em>inline</em>, which means text will flow around it, if not isolated in a containing div or column.</p>
 ...
 <p><em>Configure the Headlines Widget as follows:
  <ol>
   ...
   <li>Change the widget title if desired.</li>
  </em></ol></p>
 ...
 /* ---------------------------------------------------------- *
  * PAGE OUTPUT - BLOG BOXES
  * ---------------------------------------------------------- */

 function ade_widgets_blog_boxes_menu_output(){
 if  (!current_user_can('administrator')) { return; } //check user permissions
 ?>
 <div class="wrap">
 <h1><?php echo esc_html(get_admin_page_title() ); ?></h1>
 <p>This page configures static blog post box widgets that can be placed independently via shortcode. Each box is configured independent of the other three.</p>
 <p><strong>Shortcodes: [ade-widgets-blog-box box="1"]</strong> (or replace 1 with 2, 3, or 4).</p>
 <p><strong>NOTE: <em>Not for use in WordPress widget areas (sidebars).</em> Place this shortcode in your page or post content area only.</strong></p>
 <p><strong><em>Use the Post ID Lookup menu page to list posts for an ADE blog. Use the post IDs from that list for the Enter Post ID field below.</em></strong></p>
 <p><em>Configure each box as follows:
   <ol>
     <li>Use the dropdown to select the blog from which you want to pull posts. You must do this even if you are showing posts from this site.</li>
     <li>Enter the ID for the post you want to show. (Post IDs can be looked up via the Post ID Lookup admin screen.)</li>
     <li>If necessary, update the Banner Icon field with the name of a new <a href="http://fontawesome.io" target="_blank">Fontawesome icon (if an icon is desired).</a></li>
 ...
 <form method="post" action="options.php" id="blog-corner-form" >
      <?php submit_button('Save Settings'); ?>
   <?php
      settings_fields( 'ade_widgets_blog_boxes_settings' );
  ?>
   <?php
      do_settings_sections( 'ade_widgets_blog_boxes_menu' );
  ?>
        <?php submit_button('Save Settings'); ?>
 </form>
 </div>
...
function ade_widgets_output_half(){
  ...
  * ---------------------------------------------------------- */
  function ade_widgets_queue() {
   wp_enqueue_style( 'ade-widgets-style', plugins_url('ADE Widgets/ade-widgets-styles.css' ), array(), '1.2.0', 'all' );
